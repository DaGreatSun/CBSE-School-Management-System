...
function StaffSalaryList() {
    ...
    async function getStaffSalaryList() {
        try {
            const res = await axios.get(STAFF_SALARY_API);
    ...
    async function submitUpdate() {
        ...
        try {
            const res = await axios.put(STAFF_SALARY_API, data);
            ...
            if (res.status === HTTP_STATUS.OK) {
                ...
                getStaffSalaryList();
                reset();
                toast.success("Updated staff salary successfully!");
            }
        } catch (e) {
            toast.error("Error in updating staff salary. Please try again.");
    ...
    async function onSearch() {
        ...
        if (search !== "") {
            try {
                const res = await axios.get(STAFF_SALARY_API + "/search/" + search);
        ...
        return (
            <div className="w-full h-full p-10 py-7">
                <div className="mb-5 flex items-center">
                    ...
                    />
                    <div className="font-semibold text-2xl">All Staffs' Salary</div>
                </div>
                ...
                <div className="flex items-center justify-between mb-5">
                    <div className="flex items-center">
                        <form onSubmit={() => onSearch()}>
                            <input
                                type="text"
                                placeholder="Search staff salary by staff name..."
                ...
                <div className="mt-10 px-5 min-w-min">
                    <MyTable cardView={false} columns={columns} data={staffSalaryList} recordType="staffSalary" />
                </div>
